...
CFLAGS=-std=c11 -ffreestanding -ffunction-sections -fdata-sections \
 ...
 -Wno-unused-parameter -pedantic -I$(SYSINCDIR) \
...
all: $(BINARY) $(DISASM) $(EXTRA_ALL_TARGETS)
...
clean:
	$(RM) $(OBJECTS) $(ELF) $(BINARY) $(MAP) $(SYM) $(DISASM) $(addsuffix .lst,$(basename $(SSOURCES) $(ASMSOURCES))) $(EXTRA_CLEAN)
